# Godot98
A project that aims to convert Godot 4 (and maybe Godot 3) projects to SDL 1.2, which can run on systems as old as Windows 95 (although my focus is to run it on Windows 98).
