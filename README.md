...
inDot (short for "INfinite GoDOT" formerly known as "Godot98") will be a project that aims to port Godot 4 projects to older devices via SDL 1.2. Right now, the focus of the project is getting it to get it running under Windows 98SE.

# My Goals (and why)
I want to make video games accessible to all kinds of people. Many people would shun a project like this for being "pointless", but I think there's a chu.
